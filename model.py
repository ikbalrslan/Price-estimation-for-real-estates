...
class Model:
    ...
    def __init__(self,
        ...
        self.fully_connected.add(Dense(10, activation='sigmoid'))
        self.fully_connected.add(Dropout(0.5))
        self.fully_connected.add(Dense(10, activation='sigmoid'))
        self.fully_connected.add(Dropout(0.5))
        self.fully_connected.add(Dense(1, activation='sigmoid'))

        self.fully_connected.compile(loss='mean_absolute_error', optimizer='rmsprop',
                                     metrics=['mse', self._coeff_determination])
    ...
    def graph(self):
        ...
        axs[0].plot(self.last_train.history['_coeff_determination'])
        axs[0].plot(self.last_train.history['val__coeff_determination'])
        axs[0].set_title('accuracy')
        axs[0].set_ylim(0, 1)
        axs[0].set(ylabel='r^2 score', xlabel='epoch')
