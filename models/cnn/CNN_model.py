...
top_model_weights_path = trainpath+'_weights.h5'
train_data_dir = trainpath+ '/train'
...
def train_top_model():
    ...
    np.save(trainpath+'_class_indices.npy', generator_top.class_indices)

    # load the bottleneck features saved earlier
    train_data = np.load(trainpath+'_train_features.npy')
    ...
    validation_data = np.load(trainpath+'_validation_features.npy')
    ...
    plt.legend(['train', 'test'], loc='upper left')
    plt.show()
    plt.savefig(trainpath+"_train_validation_results.jpg")
